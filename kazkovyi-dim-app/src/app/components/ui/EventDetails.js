...
export default function EventDetails({ data, onClose }) {
  ...
  return (
    <ModalPortal>
      <div
        className="fixed inset-0 z-50 bg-opacity-30 bg-black/40 backdrop-blur-sm overflow-y-auto md:overflow-y-hidden min-h-dvh"
        onClick={() => onClose()}
      >
        <button
          aria-label="Close"
        ...
        <div className="flex min-h-dvh justify-center items-center p-6">
          <div className="bg-crema border border-ochre/70 flex flex-col justify-center items-start md:flex-row gap-2 my-8 sm:my-0 md:gap-6 rounded-2xl m-5 md:m-10 lg:m-20 xl:m-30 p-6 transition-all">
