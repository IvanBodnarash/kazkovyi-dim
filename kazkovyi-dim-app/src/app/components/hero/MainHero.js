...
import ContactsPopup from "../ui/ContactsPopup";
      ...
      <div className="flex flex-col md:flex-row mt-18 lg:mt-0 justify-center items-center">
        <div className="flex">
          ...
          <div className="max-w-2xl">
            <h1 className="hero-text-heading text-7xl sm:text-8xl md:text-[120px] lg:text-[176px] mb-[-5px] md:mb-[-10px] lg:mb-[-15px] xl:mb-[-35px]">
              КазковийДім
            </h1>
            <h2 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl/tight font-calibri font-bold text-shadow-2xs text-ochre pr-5">
              Організація та проведення дитячих свят в Чернівцях
            </h2>
            <p className="text-md md:text-lg lg:text-xl xl:text-2xl text-tender font-calibri font-normal text-shadow-xs mt-2 md:mt-6 pr-8">
