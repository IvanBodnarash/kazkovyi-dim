  ...
  return (
    <div className="mx-auto max-w-7xl px-4 pb-8 lg:pb-0 md:px-6 lg:px-8">
      <div className="mt-14 items-center font-calibri">
        ...
        >
          <div className="bg-slate-500/60 p-3 rounded-4xl relative flex justify-center overflow-hidden h-full md:h-110 lg:h-full w-full lg:w-180">
            <div
          ...
          <div>
            <ImageWithSkeleton
              ...
              height={400}
              alt="bunny"
              className="size-76 md:size-96 lg:size-125 xl:size-132.5 object-contain"
            />
          </div>
        </div>
      </div>
